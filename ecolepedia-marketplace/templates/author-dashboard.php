...
<div class="ecolepedia-app">
    <div class="ecolepedia-container">
        <div class="ecolepedia-header">
            <div>
                <h2><?php echo esc_html__('Author Dashboard', 'ecolepedia-marketplace'); ?></h2>
                <p class="ecolepedia-muted"><?php echo esc_html__('Manage assignments, deliver files, and track payouts.', 'ecolepedia-marketplace'); ?></p>
            </div>
            <a class="ecolepedia-button" href="#" style="background: <?php echo esc_attr($options['accent_color']); ?>">
                <?php echo esc_html__('View Jobs', 'ecolepedia-marketplace'); ?>
            </a>
        </div>
        <div class="ecolepedia-layout">
            <aside class="ecolepedia-sidebar">
                <h3><?php echo esc_html__('Workspace', 'ecolepedia-marketplace'); ?></h3>
                <ul class="ecolepedia-nav">
                    <li><a href="#"><?php echo esc_html__('Assignments', 'ecolepedia-marketplace'); ?></a></li>
                    <li><a href="#"><?php echo esc_html__('Messages', 'ecolepedia-marketplace'); ?></a></li>
                    <li><a href="#"><?php echo esc_html__('Earnings', 'ecolepedia-marketplace'); ?></a></li>
                    <li><a href="#"><?php echo esc_html__('Profile', 'ecolepedia-marketplace'); ?></a></li>
                </ul>
            </aside>
            <div>
                ...
                <div class="ecolepedia-card">
                    ...
                    <p class="ecolepedia-muted"><?php echo esc_html__('View requirements, chat with customers, and submit drafts.', 'ecolepedia-marketplace'); ?></p>
                    <a class="ecolepedia-button" href="#" style="background: <?php echo esc_attr($options['accent_color']); ?>">
